...
import jp.co.brycen.wms.spin00301search.process.Spin00301SearchRecCntProcess;

@Path("wms")
public class Spin00301SearchRecCntWebService extends AbstractWebService {

	@POST
	@Path("/Spin00301SearchCnt")
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Spin00301SearchResponse search(Spin00301SearchRequest item) throws SQLException {
	...
	protected AbstractProcess getProcess() {
		return new Spin00301SearchRecCntProcess(this);
	}
